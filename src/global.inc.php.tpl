...
/* $Id$ */
	...
	define('ONPHP_INCUBATOR_CLASSES', ONPHP_INCUBATOR_PATH . 'classes' . DIRECTORY_SEPARATOR);

	set_include_path(
		ONPHP_CLASSES . 'Base' . PATH_SEPARATOR .
		ONPHP_CLASSES . 'Cache' . PATH_SEPARATOR .
		ONPHP_CLASSES . 'Exceptions' . PATH_SEPARATOR .
		ONPHP_CLASSES . 'Logic' . PATH_SEPARATOR .
		ONPHP_CLASSES . 'DB' . PATH_SEPARATOR .
		...
		ONPHP_INCUBATOR_CLASSES . 'Base' . PATH_SEPARATOR .
		ONPHP_INCUBATOR_CLASSES . 'CMF' . PATH_SEPARATOR .
		ONPHP_INCUBATOR_CLASSES . 'Form' . PATH_SEPARATOR .
		ONPHP_INCUBATOR_CLASSES . 'HTTP' . PATH_SEPARATOR .
		ONPHP_INCUBATOR_CLASSES . 'Net' . PATH_SEPARATOR .
		ONPHP_INCUBATOR_CLASSES . 'NetTools' . PATH_SEPARATOR .
		ONPHP_INCUBATOR_CLASSES . 'Utils' . PATH_SEPARATOR .
		ONPHP_INCUBATOR_CLASSES . 'XML' . PATH_SEPARATOR .
		ONPHP_INCUBATOR_CLASSES . 'SimpleTestWrapper' . PATH_SEPARATOR .
