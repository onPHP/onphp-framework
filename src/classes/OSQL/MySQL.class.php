...
//			echo $query->toString($this)."\n"; flush();
			...
			if (!($result = mysql_query($query->toString($this), $this->link))) {
				throw new DatabaseException(
					"failed to execute such query - '{$query->toString($this)}': ".
		...
		**/
		...
		{
			throw new UnsupportedMethodException('implement me first!');
		}
	}
?>