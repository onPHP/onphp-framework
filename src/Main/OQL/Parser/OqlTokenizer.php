...
final class OqlTokenizer
{
	...
	private static $masks = array(
		...
		// property, class name
		OqlToken::IDENTIFIER =>
			// Old rexexp - know's nothing about namespaces
			//'\b[a-zA-Z_][a-zA-Z\d_]*(?:\.[a-zA-Z_][a-zA-Z\d_]+)*\b',
			 
			// New. Waiting for class with namespace and lead backslash. And .property if needed
			'(?<![a-zA-Z_\d\\\\.])[\\\]*[a-zA-Z_](?:[a-zA-Z_\d]+\\\)*[a-zA-Z\d_]*(?:\.[a-zA-Z_][a-zA-Z\d_]+)*\b',
