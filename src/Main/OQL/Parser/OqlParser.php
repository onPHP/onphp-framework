...
use OnPHP\Main\OQL\Expression\OqlPrefixMinusExpression;
use OnPHP\Main\OQL\Expression\OqlQueryExpression;
use OnPHP\Main\OQL\Expression\OqlQueryParameter;
use OnPHP\Main\OQL\Statement\OqlQueryClause;
...
abstract class OqlParser
{
	...
	private static $classMap = array(
		self::PREFIX_UNARY_EXPRESSION	=> PrefixUnaryExpression::class,
		self::POSTFIX_UNARY_EXPRESSION	=> PostfixUnaryExpression::class,
		self::BINARY_EXPRESSION			=> BinaryExpression::class,
		self::BETWEEN_EXPRESSION		=> LogicalBetween::class
	);
