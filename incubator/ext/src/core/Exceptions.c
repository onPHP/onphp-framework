...
{
	REGISTER_ONPHP_SUB_CLASS_EX(BusinessLogicException,			Exception,			NULL, NULL);
	REGISTER_ONPHP_SUB_CLASS_EX(UnimplementedFeatureException,	Exception,			NULL, NULL);
	REGISTER_ONPHP_SUB_CLASS_EX(BaseException,					Exception,			NULL, NULL);

	REGISTER_ONPHP_SUB_CLASS_EX(MissingElementException,		BaseException,		NULL, NULL);
	REGISTER_ONPHP_SUB_CLASS_EX(NetworkException,				BaseException,		NULL, NULL);
	REGISTER_ONPHP_SUB_CLASS_EX(UnsupportedMethodException,		BaseException,		NULL, NULL);
	REGISTER_ONPHP_SUB_CLASS_EX(WrongArgumentException,			BaseException,		NULL, NULL);
	REGISTER_ONPHP_SUB_CLASS_EX(WrongStateException,			BaseException,		NULL, NULL);
	REGISTER_ONPHP_SUB_CLASS_EX(DatabaseException,				BaseException,		NULL, NULL);
