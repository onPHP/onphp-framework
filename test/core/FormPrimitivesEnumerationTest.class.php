<?php
	...
	final class FormPrimitivesEnumerationTest extends TestCase
	{
		...
		public function testValid()
		{
			...
			$this->formAsserts($form, 'property', $value, $value, $raw, 42, 42);
		}
		...
		public function testInvalidConstraintsWithDefault()
		{
			...
			$form->get('property')->
				setDefault(SimpleEnum::thirtyTwo());
			...
			// value, safe, raw, form, export
			$this->formAsserts($form, 'property', null, SimpleEnum::thirtyTwo(), $raw, $raw, null);
		}
