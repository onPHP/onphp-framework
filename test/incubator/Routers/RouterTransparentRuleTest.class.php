<?php
	...
	class RouterTransparentRuleTest extends PHPUnit_Framework_TestCase
	{
		...
		public function testWildcardUrlVariablesOverwriting()
		{
			...
			$values = $route->match(
				$this->buildRequest('http://localhost/archives/2006/07/controller/test/year/10000/sort/author')
			);
		...
		public function testCreateInstance()
		{
			...
			$route = RouterTransparentRule::create($routeConf['route'], $routeConf['defaults']);
		...
		public function testEncode()
		{
			...
			$url = $route->assemble(array('area' => 'My Controller'), false, true);
			$this->assertEquals('My+Controller', $url);

			$url = $route->assemble(array('area' => 'My Controller'), false, false);
			$this->assertEquals('My Controller', $url);
			...
			$route = new RouterTransparentRule(':area/*', array('area' => 'My Controller'));
