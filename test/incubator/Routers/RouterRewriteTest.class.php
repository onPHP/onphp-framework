	...
	class RouterRewriteTest extends PHPUnit_Framework_TestCase
	{
		...
		**/
		...
		public function testDefaultRoute()
		{
			...
			$routes = $this->router->getRoutes();
			$this->assertType('RouterTransparentRule_Module', $routes['default']);
		}
		...
		public function testFirstRouteMatched()
		{
			...
			try {
				...
				$this->assertType('RouterTransparentRule', $this->router->getCurrentRoute());
			} catch (Exception $e) {
		...
		public function testUrlValuesHandling1()
		{
			...
			$this->assertEquals('nl/foo', $this->router->getRoute('foo')->assemble());
			$this->assertEquals('nl/bar', $this->router->getRoute('bar')->assemble());
		}
		...
		public function testUrlValuesHandling2()
		{
			...
			$this->assertEquals('en/foo', $this->router->getRoute('foo')->assemble());
			$this->assertEquals('nl/bar', $this->router->getRoute('bar')->assemble());
		}
		...
		public function testUrlValuesHandling3()
		{
			...
			$this->assertEquals('nl/foo', $this->router->getRoute('foo')->assemble());
			$this->assertEquals('en/bar', $this->router->getRoute('bar')->assemble());
		}
		...
		public function testAssemblingWithHostnameHttp()
		{
			...
			$this->assertEquals('http://www.example.com', $this->router->assemble(array(), 'hostname-route'));
		}
		...
		public function testAssemblingWithHostnameHttps()
		{
			...
			$this->assertEquals('https://www.example.com', $this->router->assemble(array(), 'hostname-route'));
		...
		public function testAssemblingWithHostnameThroughChainHttp()
		{
			...
			$this->assertEquals('http://www.example.com/bar', $this->router->assemble(array(), 'foo-bar'));
		}
		...
		public function testAssemblingWithNonFirstHostname()
		{
			...
			$this->assertEquals('bar/www.example.com', $this->router->assemble(array(), 'foo-bar'));
		}
