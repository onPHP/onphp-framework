<?php
	...
	if (isset($dbs) && $dbs) {
		...
		set_include_path(
			...
			.ONPHP_TEST_PATH.'meta'.DIRECTORY_SEPARATOR.'Auto'.PATH_SEPARATOR
			.ONPHP_TEST_PATH.'meta'.DIRECTORY_SEPARATOR.'Business'.PATH_SEPARATOR
			.ONPHP_TEST_PATH.'meta'.DIRECTORY_SEPARATOR.'DAOs'
		);
