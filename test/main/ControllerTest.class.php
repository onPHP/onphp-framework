<?php
	...
	final class ControllerTest extends UnitTestCase
	{
		private $controller;
		...
		public function setUp()
		{
			...
			$this->controller->
				setModuleDir(dirname(__FILE__).DIRECTORY_SEPARATOR.'modules')->
		...
		public function testGlobals()
		{
			$this->assertEqual(
				...
				$this->controller->getGlobals()
			);
			
			$this->controller->useGlobal('_GET', 2);
			
			$this->assertEqual(
				array('_POST', '_SESSION', '_GET', '_COOKIE'),
				$this->controller->getGlobals()
			);
			...
			$this->assertEqual(
				array('_POST', '_SESSION', '_GET', '_COOKIE', 'custom'),
				$this->controller->getGlobals()
			);
			...
			$this->assertEqual(
				array('_POST', 'other', '_SESSION', '_GET', '_COOKIE', 'custom'),
				$this->controller->getGlobals()
			);
			...
			$this->assertEqual(
				array('other', '_SESSION', '_GET', '_COOKIE', 'custom'),
				$this->controller->getGlobals()
			);
		}
		...
		{
			$this->assertEqual(
				array($this->controller, 'moduleHandler'),
				$this->controller->getModuleHandler()
			);
			
			$this->assertEqual(
				$this->controller,
				$this->controller->setModuleHandler('custom')
			);
			...
			$this->assertEqual(
				$this->controller,
				$this->controller->setModuleHandler(
					array($this->controller, 'moduleHandler')
				)
			);
			...
			$this->assertEqual(
				array($this->controller, 'templateHandler'),
				$this->controller->getTemplateHandler()
			);
			
			$this->assertEqual(
				$this->controller,
				$this->controller->setTemplateHandler('custom')
			);
			...
			$this->assertEqual(
				$this->controller,
				$this->controller->setTemplateHandler(
					array($this->controller, 'templateHandler')
				)
			);
			...
			$this->assertEqual(
				dirname(__FILE__).DIRECTORY_SEPARATOR.'modules',
				$this->controller->getModuleDir()
			);
			
			$this->assertEqual(
				$this->controller,
				$this->controller->setTemplateDir(
			...
			$this->assertEqual(
				dirname(__FILE__).DIRECTORY_SEPARATOR.'templates',
				$this->controller->getTemplateDir()
			);
			
			$this->assertEqual(EXT_MOD, $this->controller->getModuleExt());
			
			$this->assertEqual(
				$this->controller,
				$this->controller->setModuleExt('custom')
			);
			
			$this->assertEqual(
				'custom',
				$this->controller->getModuleExt()
			);
			
			$this->assertEqual(
				$this->controller,
				$this->controller->setModuleExt(EXT_MOD)
			);
			
			$this->assertEqual(EXT_MOD, $this->controller->getModuleExt());
			
			$this->assertEqual(EXT_TPL, $this->controller->getTemplateExt());
			
			$this->assertEqual(
				$this->controller,
				$this->controller->setTemplateExt('custom')
			);
			
			$this->assertEqual(
				'custom',
				$this->controller->getTemplateExt()
			);
			
			$this->assertEqual(
				$this->controller,
				$this->controller->setTemplateExt(EXT_TPL)
			);
			...
			$this->assertEqual(
				$this->controller,
				$this->controller->setAction('custom')
			);
			...
			$this->assertEqual(
				$this->controller,
				$this->controller->setDefault('custom')
			);
			...
			$this->assertEqual(
				$this->controller,
				$this->controller->setDefault('default')
			);
		...
		public function testTemplateHandler()
		{
			$this->assertEqual(
				$this->controller,
				$this->controller->templateHandler()
			);
			...
			$this->assertEqual(
				'third'.DIRECTORY_SEPARATOR.'tfirst',
