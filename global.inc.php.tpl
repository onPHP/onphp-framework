...
/* $Id$ */
	...
	set_include_path(
		...
		.ONPHP_MAIN_PATH.'OQL'.DIRECTORY_SEPARATOR.'Grammar'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'OQL'.DIRECTORY_SEPARATOR.'Parsers'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'OQL'.DIRECTORY_SEPARATOR.'Parsers'.DIRECTORY_SEPARATOR.'Strategies'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'OQL'.DIRECTORY_SEPARATOR.'Parsers'.DIRECTORY_SEPARATOR.'Tokenizer'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'OQL'.DIRECTORY_SEPARATOR.'Statements'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'OQL'.DIRECTORY_SEPARATOR.'SyntaxTree'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'OQL'.DIRECTORY_SEPARATOR.'SyntaxTree'.DIRECTORY_SEPARATOR.'Mutators'.PATH_SEPARATOR
