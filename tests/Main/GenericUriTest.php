...
use OnPHP\Main\Net\Url;
use OnPHP\Main\Net\Urn;
...
final class GenericUriTest extends TestCase
{
	private $urls = array(
		...
		'//ya0.ru'	=> null,
		'//yandex.ru'	=> Url::class,
		'//yandex.ru:80'	=> Url::class,
		'ya1.ru'	=> null,
		'ya2.ru'	=> Url::class,
		'ya3.ru'	=> HttpUrl::class,
		'http:ya4.ru'	=> HttpUrl::class,
		'http:/ya5.ru'	=> HttpUrl::class,
		'http:///ya6.ru'	=> HttpUrl::class,

		'hTTP://onphp.org'	=> HttpUrl::class,
	);
	...
	public function testParser()
	{
		...
		*/
		...
		foreach ($stamps as &$item){
			$item = str_replace("class: HttpUrl", 'class: '.HttpUrl::class, $item);
			$item = str_replace("class: Urn", 'class: '.Urn::class, $item);
			$item = str_replace("class: GenericUri", 'class: '.GenericUri::class, $item);
			$item = str_replace("class: Url", 'class: '.Url::class, $item);
		}
